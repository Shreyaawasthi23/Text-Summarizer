	        ...
	        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
	          <!-- Add icons to the links using the .nav-icon class
		        ...
		        <li class="nav-item menu-open">
		            <a href="viewFeedback.php" class="nav-link active">
	                	...
	                	<div class="card card-primary">
	                		...
	                		<div class="card-body">
	                			<table class="table">
	                				...
	                				<tbody>
	                					<?php
						                $sql = "SELECT `feedback_id`, `user_id`, `message`, `date`, `time`, `rating` FROM `feedback`";
							            ...
							            <tr>
							            	...
							            	<td>
							            		<button class="btn btn-primary" data-target="#View" data-toggle="modal" style="background: none; border: none;" onclick="feedback('<?php echo $r['feedback_id']; ?>')"><i class="fa-eye fas nav-icon text-purple"></i></button>
							            	</td>
							            </tr>
							            <?php    	
						                ?>
